  ...
  const getCities = async (countryName, stateName) => {
    try {
      let response = await fetch(
        `${baseUrl}/country=${countryName}/state=${stateName}/cities`
      );
      let data = await response.json();
      setCities(data);
      ...
      <div className="container">
        ...
        <div className="dropdownContainer">
          ...
          <select
            ...
            disabled={isDisabledStateDropdown}
          >
          ...
          <select
            ...
            disabled={isDisabledCityDropdown}
          >
        ...
        {storeCountry && (
          <div>
            <span data-testid="selected-location">
              You selected {storeCity}, {storeState}, {storeCountry}
            </span>
          </div>
        )}
      </div>
